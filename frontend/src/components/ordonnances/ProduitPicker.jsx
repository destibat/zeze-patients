...
const ProduitPicker = ({ lignes = [], onChange, posologie }) => {
              ...
              {produitsFiltres.length === 0 ? (
                ...
                produitsFiltres.map((p) => (
                  ...
                  >
                    ...
                    <span className="text-xs font-mono text-zeze-vert">
        ...
        <div className="border border-bordure rounded-carte overflow-hidden">
          <table className="w-full text-sm">
            ...
            <tfoot className="bg-fond-secondaire border-t border-bordure">
              <tr>
                <td colSpan={4} className="px-3 py-2 text-xs font-semibold text-texte-secondaire text-right">TOTAL</td>
